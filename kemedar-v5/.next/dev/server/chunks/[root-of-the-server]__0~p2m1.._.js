...
async function POST(request) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].findByEmail(email);
        if (!user || !user.passwordHash) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid credentials", 401);
        if (!user.isActive) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Account is disabled", 403);
        const isValid = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcryptjs__$5b$external$5d$__$28$bcryptjs$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$bcryptjs$29$__["default"].compare(password, user.passwordHash);
        if (!isValid) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])("Invalid credentials", 401);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["userRepository"].update(user.id, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0~p2m1.._.js.map