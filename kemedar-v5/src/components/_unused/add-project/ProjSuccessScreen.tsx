...
const REF = `KEM-P${Math.floor(10000 + Math.random() * 90000)}`;

export default function ProjSuccessScreen({ onViewProject, onAddAnother }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="text-3xl font-black text-gray-900 mb-2">Project Submitted!</h1>
      ...
      <p className="text-gray-500 text-base leading-relaxed mb-10 max-w-xs">
        Your project is being reviewed and will be live within 24 hours.
      </p>
      <button onClick={onViewProject} className="w-full bg-orange-600 text-white font-black py-4 rounded-2xl text-base mb-3">
        View My Project
      </button>
