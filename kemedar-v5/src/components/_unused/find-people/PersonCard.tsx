  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
      ...
      <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
        ...
        <button onClick={() => router.push(profilePath)} className="flex-1 py-2.5 rounded-xl border border-orange-600 text-orange-600 text-sm font-bold">👤 View Profile</button>
      </div>
    </div>
  );
}
...
export function DeveloperCard({ person }) {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
      ...
      <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
        <button className="flex-1 py-2.5 rounded-xl border border-orange-600 text-orange-600 text-sm font-bold">💬 Chat</button>
        <button onClick={() => router.push(profilePath)} className="flex-1 py-2.5 rounded-xl border border-orange-600 text-orange-600 text-sm font-bold">🏗 View Projects</button>
      </div>
    </div>
  );
}
...
export function AgencyCard({ person }) {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
      ...
      <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
        <button className="flex-1 py-2.5 rounded-xl border border-orange-600 text-orange-600 text-sm font-bold">💬 Chat</button>
        <button onClick={() => router.push(profilePath)} className="flex-1 py-2.5 rounded-xl border border-orange-600 text-orange-600 text-sm font-bold">🏢 View Agency</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
      ...
      <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
        ...
        <button onClick={() => router.push(profilePath)} className="flex-1 py-2.5 rounded-xl bg-orange-600 text-white text-sm font-bold">📋 Assign Task</button>
      </div>
    </div>
  );
}