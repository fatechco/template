...
export default function KemedarAdminDashboard() {
  ...
  useEffect(() => {
    apiClient.get("/api/v1/" + "propertytoken", "-created_date", 100).then(setVpTokens).catch(() => {});
    apiClient.get("/api/v1/" + "verificationrecord", "-recordedAt", 5).then(setVpRecords).catch(() => {});
  }, []);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-br from-gray-900 to-slate-800 rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-5">
          ...
          <Link href="/admin/kemedar/verify-pro" className="text-xs text-orange-400 font-bold hover:underline">View Full Dashboard →</Link>
        </div>
        ...
        <Link href="/admin/kemedar/verify-pro"
