        ...
        <nav className="hidden md:flex items-center gap-1 text-sm text-gray-500">
          ...
          {breadcrumb.map((item, i) => (
            <span key={i} className="flex items-center gap-1">
              {item.to ? (
                <Link href={item.to || "#"} className="hover:text-gray-800 transition-colors">{item.label}</Link>
              ) : (
          ...
          {dropdownOpen && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50">
                <Link href="/dashboard/profile" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <Link href="/dashboard/switch-role" onClick={() => setDropdownOpen(false)} className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
