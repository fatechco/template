    ...
    <div className="bg-[#0d1b3e] py-14 text-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center">
          <Link href="/kemedar/expat/setup" className="inline-block bg-orange-500 hover:bg-orange-400 text-white font-black px-8 py-4 rounded-2xl text-lg transition-all hover:scale-105">
