    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-5 mb-4">
        <div className="flex items-start justify-between mb-3">
          ...
          <Link href="/dashboard/escrow" className="text-xs bg-white/10 hover:bg-white/20 text-white font-bold px-3 py-1.5 rounded-xl flex items-center gap-1 transition-colors">
      ...
      <div className="mt-4 bg-red-50 border border-red-100 rounded-2xl p-4">
        ...
        <Link href="/dashboard/escrow" className="inline-flex items-center gap-1 text-xs bg-red-600 text-white font-bold px-3 py-2 rounded-xl hover:bg-red-700 transition-colors">
