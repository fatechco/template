        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-2xl p-5">
            ...
            <div className="flex gap-2 flex-wrap">
              <Link href="/kemedar/add/property" className="flex items-center gap-1 bg-white text-orange-600 font-black px-4 py-2 rounded-xl text-xs hover:bg-orange-50 transition-colors">
                + List Property <ExternalLink size={10} />
              </Link>
              <Link href="/kemedar/negotiate" className="flex items-center gap-1 bg-white/20 hover:bg-white/30 text-white font-bold px-4 py-2 rounded-xl text-xs transition-colors">
                📊 Negotiate™ Strategy
              </Link>
              <Link href="/kemedar/predict" className="flex items-center gap-1 bg-white/20 hover:bg-white/30 text-white font-bold px-4 py-2 rounded-xl text-xs transition-colors">
                📈 Full Predict™ Report
              </Link>
            </div>
          </div>
