  ...
  return (
    <div className={`absolute top-full left-0 mt-0 bg-white rounded-b-xl shadow-2xl border border-gray-100 z-[150] ${showKemetroKemework ? 'w-[520px]' : 'w-[280px]'}`}>
        ...
        <div className={showKemetroKemework ? "border-r border-gray-100" : ""}>
          ...
          <ul className="flex flex-col">
            {[
              ...
              <li key={item.title}>
                <Link href={item.to || "#"} className="flex items-start gap-3 px-6 py-3 hover:bg-orange-50 transition-colors border-b border-gray-50 last:border-b-0">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-t border-orange-200 px-6 py-3">
        <Link href="/user-benefits" className="inline-flex items-center gap-2 text-sm font-bold text-orange-600 hover:text-orange-700 transition-colors">
