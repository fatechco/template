    ...
    >
      <div className="max-w-[1400px] mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <Link href="/thinkdar" className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 rounded-full text-[11px] font-black uppercase tracking-widest transition-all hover:opacity-80" style={{ background: "rgba(99,102,241,0.2)", border: "1px solid #6366F1", color: "#6366F1" }}>
        ...
        <div className="text-center mt-6">
          <Link href={exploreLink} className="text-white text-sm font-bold hover:underline opacity-70 hover:opacity-100 transition-opacity">
