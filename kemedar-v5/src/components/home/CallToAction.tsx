    ...
    <section className="w-full py-16 bg-gradient-to-r from-[#FF6B00] via-[#ff8c00] to-[#e55f00] relative overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 flex flex-col items-center text-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <Link href="/create/property" className="flex items-center gap-2 border-2 border-white text-white hover:bg-white hover:text-[#FF6B00] font-bold px-7 py-3 rounded-xl transition-all text-sm">
            <Plus size={16} /> List Property Now
          </Link>
          <Link href="/find-profile/real-estate-agents" className="flex items-center gap-2 border-2 border-white text-white hover:bg-white hover:text-[#FF6B00] font-bold px-7 py-3 rounded-xl transition-all text-sm">
