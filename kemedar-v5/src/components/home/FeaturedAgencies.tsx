    ...
    <div className="flex-shrink-0 w-64 bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 group">
      ...
      <div className="p-3">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <Link href={`/agency-profile/${agency.id}`} className="flex-1 flex items-center justify-center gap-1 bg-[#FF6B00] hover:bg-[#e55f00] text-white text-xs font-semibold py-1.5 rounded-lg transition-colors">
