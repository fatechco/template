  ...
  return (
    <div className="bg-white rounded-2xl border-t-4 border-purple-500 shadow-sm hover:shadow-lg transition-all overflow-hidden">
      ...
      <div className="p-4">
        ...
        <Link href={`/kemetro/flash/deal/${deal.id}`} className="mt-3 block w-full bg-purple-600 hover:bg-purple-700 text-white font-black py-2.5 rounded-xl text-center text-sm transition-colors">
          📦 View Clearance Deal
        </Link>
      </div>
    </div>
