    ...
    <div className="bg-white rounded-2xl border-l-4 border-teal-500 shadow-sm hover:shadow-lg transition-all overflow-hidden">
      ...
      <div className="px-4 pb-4 border-t border-gray-100 pt-3">
        ...
        <div className="flex gap-2 mt-2">
          ...
          <Link href={`/kemetro/flash/compound/${deal.id}`} className="flex-1 text-center text-xs border border-gray-200 text-gray-600 font-bold py-2 rounded-xl hover:bg-gray-50 transition-colors">👁 Details</Link>
        </div>
      </div>
    </div>
  );
