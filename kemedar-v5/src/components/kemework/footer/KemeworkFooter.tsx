  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <ul className="flex flex-col gap-2">
        {links.map(link => (
          <li key={link.to}>
            <Link href={link.to} className="text-xs transition-colors" style={{ color: "rgba(255,255,255,0.55)" }}
      ...
      <div className="border-t" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="max-w-[1400px] mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>
            <Link href="/kemework/terms" className="hover:text-white transition-colors">Terms</Link>
            <span style={{ color: "rgba(255,255,255,0.2)" }}>·</span>
            <Link href="/kemework/privacy" className="hover:text-white transition-colors">Privacy</Link>
            <span style={{ color: "rgba(255,255,255,0.2)" }}>·</span>
            <Link href="/kemework/contact" className="hover:text-white transition-colors">Contact Us</Link>
          </div>
