    ...
    <div className="py-16 px-4" style={{ background: "#F8F5F0" }}>
      <div className="max-w-[1200px] mx-auto">
              ...
              <div key={pro.id} className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 flex flex-col">
                ...
                <div className="text-center px-4 pb-4 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    <Link href={`/kemework/profile/${pro.id}`} className="flex-1 py-2 rounded-lg text-xs font-bold text-white text-center transition-all hover:opacity-90" style={{ background: "#C41230" }}>👤 View Profile</Link>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="text-center mt-6">
          <Link href="/kemework/find-professionals" className="text-sm font-bold" style={{ color: "#C41230" }}>
