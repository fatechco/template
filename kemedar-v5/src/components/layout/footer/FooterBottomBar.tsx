    ...
    >
      ...
      >
        ...
        <div style={{ flex: "0 0 30%" }} className="flex items-center justify-center gap-1 flex-wrap" style={{ color: "#6B7280", fontSize: 11 }}>
          ...
          <Link href="/terms" className="hover:text-orange-400 transition-colors">Privacy</Link>
          <span style={{ color: "#374151", margin: "0 6px" }}>·</span>
          <Link href="/terms" className="hover:text-orange-400 transition-colors">Cookies</Link>
          <span style={{ color: "#374151", margin: "0 6px" }}>·</span>
          <Link href="/sitemap" className="hover:text-orange-400 transition-colors">Sitemap</Link>
          <span style={{ color: "#374151", margin: "0 6px" }}>·</span>
          <Link href="/thinkdar" className="hover:text-orange-400 transition-colors">API Terms</Link>
        </div>
      ...
      <div className="flex flex-col items-center gap-2 md:hidden py-4 px-5 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2" style={{ color: "#6B7280", fontSize: 10 }}>
          ...
          <span>·</span>
          <Link href="/terms" className="hover:text-orange-400">Privacy</Link>
          <span>·</span>
          <Link href="/sitemap" className="hover:text-orange-400">Sitemap</Link>
          <span>·</span>
          <Link href="/thinkdar" className="hover:text-orange-400">API Terms</Link>
        </div>
