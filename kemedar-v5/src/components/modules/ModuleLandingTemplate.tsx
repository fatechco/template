  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className={`bg-gradient-to-br ${heroGradient} text-white py-20 px-6`}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href={ctaTo} className={`${ctaColor} text-white font-black px-8 py-4 rounded-2xl text-base transition`}>
              {ctaLabel}
            </Link>
            {secondaryCta && (
              <Link href={secondaryCta.to} className="border border-white/30 text-white font-bold px-6 py-4 rounded-2xl text-sm hover:bg-white/10 transition">
                {secondaryCta.label}
              </Link>
            )}
          </div>
      ...
      <div className="bg-gray-50 py-16 px-6 text-center">
        ...
        <Link href={ctaTo} className={`${ctaColor} text-white font-black px-10 py-4 rounded-2xl text-base transition`}>
          {ctaLabel}
        </Link>
      </div>
