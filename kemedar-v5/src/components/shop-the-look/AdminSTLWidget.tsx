...
export default function AdminSTLWidget() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      apiClient.list("/api/v1/analyzedpropertyimage", { isAnalyzed: true, isShoppable: true }, "-created_date", 50),
      apiClient.list("/api/v1/hotspotsponsorshiplog", { eventType: "click" }, "-recordedAt", 200),
      apiClient.list("/api/v1/shopthelookcart", {}, "-addedAt", 100),
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/admin/kemetro/shop-the-look" className="text-xs text-teal-600 font-bold hover:underline">
          View Full Dashboard →
        </Link>
      </div>
      ...
      <Link
        href="/admin/kemetro/shop-the-look"
