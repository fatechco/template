    ...
    <div className="bg-white shadow-sm sticky top-0 z-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="pt-3 pb-1">
          <Link href="/dashboard/swap?tab=negotiations" className="flex items-center gap-1 text-gray-400 hover:text-gray-700 text-xs font-medium transition-colors w-fit">
