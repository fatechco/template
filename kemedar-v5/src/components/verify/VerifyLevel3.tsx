...
function DocCard({ docType, docData, tokenId, propertyId, userId, onUpdate }) {
  ...
  const handleUpload = async (file) => {
    ...
    const docRecord = await apiClient.post("/api/v1/verificationdocument", {
    ...
    // Trigger AI analysis
    const result = await apiClient.post("/api/v1/ai/analyzeDocumentWithAI", { documentId: docRecord.id });
