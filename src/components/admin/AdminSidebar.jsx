          ...
          {item.children.map(child => (
            <Link
              ...
              className={`flex items-center px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all
                ${location.pathname === child.to ? "bg-orange-50 text-orange-600" : "text-gray-500 hover:bg-gray-50 hover:text-gray-800"}`}
            >
              {child.label}
            </Link>
          ))}
    ...
    <>
      ...
      `}>
        ...
        <div className="border-t border-gray-100 p-3 space-y-1">
          <Link to="/dashboard" className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs text-gray-500 hover:bg-gray-50 hover:text-gray-800 transition-all">
