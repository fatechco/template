...
const MENU = [
  { label: "Dashboard", icon: BarChart3, to: "/m/cp/agency" },
  {
    label: "My Business", icon: Briefcase, children: [
      { label: "Business Profile", icon: UserSquare, to: "/m/cp/agency/business-profile" },
      { label: "Manage Agents", icon: Users, to: "/m/cp/agency/my-agents" },
      { label: "Performance Stats", icon: BarChart3, to: "/m/cp/agency/performance" },
      { label: "Clients", icon: Users, to: "/m/cp/agency/clients" },
      { label: "Appointments", icon: Calendar, to: "/m/cp/agency/appointments" },
    ]
  },
  {
    label: "🏙 Kemedar", icon: MapPin, children: [
      ...
      { label: "My Properties", icon: FileText, to: "/m/cp/agency/my-properties" },
      { label: "Add New Property", icon: Plus, to: "/m/add/property" },
      { label: "My Favorites", icon: Star, to: "/cp/agency/favorites" },
      { label: "Compare Properties", icon: GitCompare, to: "/cp/agency/compare" },
      { heading: "REQUESTS" },
      { label: "Add Buy Request", icon: Plus, to: "/m/add/buy-request" },
      { label: "My Buy Requests", icon: ClipboardList, to: "/m/cp/agency/my-buy-requests" },
      { label: "Search Buy Requests", icon: Search, to: "/cp/agency/search-requests" },
      { heading: "ORGANIZERS" },
      { label: "Buyer Organizer", icon: KanbanSquare, to: "/m/cp/agency/buyer-organizer" },
      { label: "Seller Organizer", icon: KanbanSquare, to: "/m/cp/agency/seller-organizer" },
      { heading: "PROJECTS" },
      { label: "Find Project", icon: Search, to: "/search-projects" },
      { label: "Add Project", icon: Plus, to: "/m/add/project" },
      { label: "My Projects", icon: Briefcase, to: "/m/cp/agency/my-projects" },
    ]
  },
  {
    label: "🔧 Kemework", icon: HardHat, children: [
      ...
      { label: "My Tasks", icon: FileText, to: "/m/cp/agency/kemework/my-tasks" },
      { label: "My Task Orders", icon: ClipboardList, to: "/m/cp/agency/kemework/orders" },
      { heading: "FIND & BROWSE" },
      ...
      { heading: "SAVED" },
      { label: "Bookmarked Pros & Services", icon: Bookmark, to: "/m/cp/agency/kemework/bookmarks" },
    ]
  },
  {
    label: "🛒 Kemetro", icon: ShoppingCart, children: [
      ...
      { heading: "MY ORDERS" },
      { label: "All Orders", icon: ClipboardList, to: "/m/cp/agency/kemetro-orders" },
      { heading: "REQUESTS" },
      { label: "My RFQs", icon: FileText, to: "/m/cp/agency/kemetro-rfqs" },
    ]
  },
  { label: "💎 Premium Services", icon: CreditCard, to: "/m/cp/agency/subscription" },
  {
    label: "🤖 AI & Smart Tools", icon: Star, children: [
      { heading: "PROPERTY AI" },
      { label: "Vision™ — Photo Analysis", icon: Star, to: "/m/cp/agency/vision" },
      { label: "Negotiate™ — Deal Coach", icon: MessageCircle, to: "/m/cp/agency/negotiations" },
      { label: "Escrow™", icon: CreditCard, to: "/m/cp/agency/escrow" },
      { heading: "MY PROFILE" },
      { label: "Kemedar Score", icon: Star, to: "/m/cp/agency/score" },
      { label: "My DNA Profile", icon: UserSquare, to: "/m/cp/agency/my-dna" },
    ]
  },
  {
    label: "💰 Money & Orders", icon: DollarSign, children: [
      { heading: "KEMEDAR" },
      { label: "Kemedar Orders", icon: ClipboardList, to: "/m/cp/agency/kemedar-orders" },
      { heading: "KEMETRO" },
      { label: "Kemetro Orders", icon: ShoppingCart, to: "/m/cp/agency/kemetro-orders" },
      { label: "My RFQs", icon: FileText, to: "/m/cp/agency/kemetro-rfqs" },
      { heading: "KEMEWORK" },
      { label: "Kemework Orders", icon: ClipboardList, to: "/m/cp/agency/kemework-orders" },
      { heading: "PAYMENTS" },
      { label: "Wallet", icon: CreditCard, to: "/m/cp/agency/wallet" },
      { label: "Invoices", icon: FileText, to: "/m/cp/agency/invoices" },
      { label: "Payment Methods", icon: CreditCard, to: "/m/cp/agency/payment-methods" },
    ]
  },
  {
    label: "🗂 Tools & Communications", icon: MessageCircle, children: [
      { heading: "COMMUNICATIONS" },
      { label: "Messages", icon: MessageCircle, to: "/m/cp/agency/messages" },
      { label: "Notifications", icon: Bell, to: "/m/cp/agency/notifications" },
      { heading: "ACCOUNT" },
      { label: "My Profile", icon: User, to: "/m/cp/agency/profile" },
      { label: "Subscription & Billing", icon: CreditCard, to: "/m/cp/agency/subscription" },
      { label: "Settings", icon: Settings, to: "/m/cp/agency/settings" },
    ]
  },
  {
    label: "❓ Help", icon: HelpCircle, children: [
      { label: "Support Tickets", icon: Bell, to: "/m/cp/agency/tickets" },
      { label: "Help Center & FAQ", icon: FileText, to: "/m/cp/agency/knowledge" },
      { label: "Contact Us", icon: MessageCircle, to: "/m/cp/agency/contact-kemedar" },
    ]
  },
];
...
const BOTTOM_TABS = [
  { id: "settings", label: "Settings", icon: Settings, path: "/m/cp/agency/settings" },
...
export default function MobileAgencyShell() {
  ...
  const isActive = (to) => to && (pathname === to || (to !== "/m/cp/agency" && pathname.startsWith(to)));
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
          ...
          <h2 className="font-bold text-gray-900 text-sm flex-1 text-center">Agency</h2>
          <div className="w-8" />
        </div>
