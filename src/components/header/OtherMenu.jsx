    ...
    <div className="absolute top-full right-0 mt-0 bg-white rounded-b-xl shadow-2xl border border-gray-100 z-[150] w-[260px]">
      <div className="py-3 px-3">
        {OTHER_ITEMS.map((item) => (
          <Link key={item.label} to={item.to} className="flex items-center gap-3 w-full text-left px-3 py-2.5 rounded-lg hover:bg-orange-50 hover:text-[#FF6B00] text-gray-700 text-sm transition-colors">
