...
function ProjectCard({ project, index }) {
  ...
  return (
    <Link to={`/property/${project.id}`} className="flex-shrink-0 w-64 bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group">
      {/* Image */}
...
export default function FeaturedProjects() {
  ...
  useEffect(() => {
    base44.entities.Project.filter({ is_featured: true, is_active: true }, "-created_date", 20)
