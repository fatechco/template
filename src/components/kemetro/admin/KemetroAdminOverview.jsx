  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-green-50 border border-green-100 rounded-2xl px-5 py-4 flex flex-wrap items-center gap-4">
        ...
        <Link to="/admin/kemetro/surplus" className="ml-auto text-xs text-green-700 border border-green-300 font-bold px-4 py-2 rounded-xl hover:bg-green-100 transition-colors whitespace-nowrap">
          View ESG Dashboard →
        </Link>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl px-5 py-4 flex flex-wrap items-center gap-4">
        ...
        <Link to="/admin/kemetro/kemekits" className="ml-auto text-xs text-blue-700 border border-blue-300 font-bold px-4 py-2 rounded-xl hover:bg-blue-100 transition-colors whitespace-nowrap">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/admin/kemetro/kemekits" className="text-xs text-blue-600 font-bold hover:underline">View Full Dashboard →</Link>
        </div>
        ...
        <Link to="/admin/kemetro/kemekits" className="block w-full text-center border-2 border-blue-400 text-blue-600 font-black py-2.5 rounded-xl text-sm hover:bg-blue-50 transition-all">
