    ...
    <div className="absolute top-full left-0 mt-0 bg-white rounded-b-xl shadow-2xl border border-gray-100 z-[200] w-[520px]">
      <div className="flex">
        ...
        <div className="flex-1 p-4">
          ...
          <Link
            to={`/kemetro/category/${category.slug}`}
...
export default function KemetroCategoryNav() {
  ...
  useEffect(() => {
    base44.entities.KemetroCategory.filter({ isActive: true })
      .then((data) => {
  ...
  const activeSlug = location.pathname.split("/kemetro/category/")[1];
      ...
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex items-center">
          ...
          <div className="flex items-center gap-1 flex-shrink-0 border-l border-gray-300 pl-3 ml-2">
            <Link to="/kemetro/flash-deals" className="flex items-center gap-1.5 px-3 py-2.5 text-sm font-bold text-red-500 hover:bg-red-50 rounded transition-colors whitespace-nowrap">
              <Flame size={14} /> Flash Deals
            </Link>
            <Link to="/kemetro/new-arrivals" className="flex items-center gap-1.5 px-3 py-2.5 text-sm font-bold text-[#0077B6] hover:bg-blue-50 rounded transition-colors whitespace-nowrap">
              <Sparkles size={14} /> New Arrivals
            </Link>
            <Link to="/kemetro/top-rated" className="flex items-center gap-1.5 px-3 py-2.5 text-sm font-bold text-yellow-600 hover:bg-yellow-50 rounded transition-colors whitespace-nowrap">
            ...
            <Link
              ...
              className={`flex items-center gap-1.5 px-3 py-2.5 text-sm font-bold hover:bg-green-50 rounded transition-colors whitespace-nowrap border-b-2 ${
                location.pathname.startsWith("/kemetro/surplus")
