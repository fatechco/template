    ...
    <div className="w-full bg-[#0d3b3b] text-white text-xs">
      <div className="max-w-[1400px] mx-auto px-4 h-9 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Sign Up */}
          <Link to="/kemetro/register" className="flex items-center gap-1 px-2.5 py-1 rounded hover:bg-white/10 transition-colors text-gray-300 hover:text-white">
            <User size={12} />
            <span>Sign Up</span>
          </Link>

          {/* Sign In */}
          <Link to="/kemetro/login" className="flex items-center gap-1 px-2.5 py-1 rounded hover:bg-white/10 transition-colors text-gray-300 hover:text-white">
            <LogIn size={12} />
            <span>Sign In</span>
          </Link>
          ...
          {/* Cart */}
          <Link to="/kemetro/cart" className="relative flex items-center gap-1 px-2.5 py-1 rounded hover:bg-white/10 transition-colors text-gray-300 hover:text-white">
