    ...
    <>
      ...
      <div className="w-full bg-white h-16 flex items-center px-4" style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
        <div className="max-w-[1400px] mx-auto w-full flex items-center gap-6">
          ...
          {/* Logo */}
          <Link to="/kemework" className="flex-shrink-0">
            <img
          ...
          <nav className="flex items-center gap-1 flex-1">
            ...
            <Link to="/kemework/find-professionals" className="px-3 py-2 text-sm font-semibold text-gray-700 hover:text-[#C41230] rounded-lg hover:bg-red-50 transition-colors whitespace-nowrap">
              Find Professionals
            </Link>
            <Link to="/kemework/find-marketer" className="px-3 py-2 text-sm font-semibold text-gray-700 hover:text-[#C41230] rounded-lg hover:bg-red-50 transition-colors whitespace-nowrap">
              Find Marketer
            </Link>
            <Link to="/kemework/service-companies" className="px-3 py-2 text-sm font-semibold text-gray-700 hover:text-[#C41230] rounded-lg hover:bg-red-50 transition-colors whitespace-nowrap">
              Service Companies
            </Link>
            ...
            <Link to="/kemework/how-it-works" className="px-3 py-2 text-sm font-semibold text-gray-700 hover:text-[#C41230] rounded-lg hover:bg-red-50 transition-colors whitespace-nowrap">
              How It Works
            </Link>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {/* Messages */}
            <button onClick={() => navigate("/kemework/messages")} className="relative p-2 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            {/* Notifications */}
            <button onClick={() => navigate("/kemework/notifications")} className="relative p-2 rounded-lg hover:bg-gray-100 transition-colors">
