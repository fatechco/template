            ...
            <div key={task.id} className="bg-white rounded-2xl border border-gray-100 p-5 flex flex-col hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100">
                ...
                <div className="flex gap-2">
                  ...
                  <Link to={`/kemework/task/${task.id}`} className="px-3 py-1.5 rounded-lg text-xs font-bold text-gray-700 border border-gray-200 hover:bg-gray-50 transition-colors">
                    View →
                  </Link>
                </div>
              </div>
