...
export default function MobileBottomNav() {
  ...
  const isActive = (tab) => {
    if (tab.id === 'settings') return location.pathname === '/m/settings';
    if (tab.id === 'account') return location.pathname.startsWith('/m/account') || location.pathname.startsWith('/m/dashboard');
