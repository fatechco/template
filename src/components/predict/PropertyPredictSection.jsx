...
export default function PropertyPredictSection({ property }) {
  ...
  useEffect(() => {
    ...
    base44.entities.PricePrediction.filter(query, "-generatedAt", 1)
    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        <div className="bg-gray-50 rounded-xl p-6 text-center">
          ...
          <Link to="/kemedar/predict" className="inline-flex items-center gap-1 text-indigo-600 text-sm font-bold hover:underline">
