...
export default function FilterSidebar({ filters, onChange }) {
  ...
  useEffect(() => {
    ...
    base44.entities.Project.list(undefined, 100).then(projs => {
  ...
  useEffect(() => {
    ...
    if (filters.country) base44.entities.Province.filter({ country_id: filters.country }).then(setProvinces).catch(() => {});
  }, [filters.country]);
