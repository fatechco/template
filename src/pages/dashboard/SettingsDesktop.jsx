  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6]">
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-5 pb-16">
        ...
        <h1 className="font-black text-[#1F2937] text-2xl mb-2">Settings</h1>
        ...
        <SettingsSection label="ACCOUNT">
          <SettingsNavItem emoji="👤" label="Edit Profile" onPress={() => navigate("/cp/user/profile")} />
          <div className="h-px bg-[#F3F4F6] mx-4" />
        ...
        <SettingsSection label="LEGAL">
          ...
          <div className="h-px bg-[#F3F4F6] mx-4" />
          <SettingsNavItem emoji="📞" label="Contact Support" onPress={() => navigate("/cp/user/contact-kemedar")} />
        </SettingsSection>
