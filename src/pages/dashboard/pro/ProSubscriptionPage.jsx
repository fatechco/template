...
const PLANS = [
  {
    ...
    features: ["Up to 5 Active Services", "Basic Profile Listing", "Standard Search Visibility", "Email Support", "10 Bids / Month"],
  },
  {
    name: "Professional",
    price: 99,
    color: "border-teal-400 bg-teal-50 ring-2 ring-teal-300",
    badge: "bg-teal-100 text-teal-700",
    features: ["Unlimited Active Services", "Verified Badge 🏅", "Priority Search Ranking", "25 Bids / Month", "Analytics Dashboard", "WhatsApp Lead Alerts", "Priority Support"],
    popular: true,
  },
  {
    name: "Premium",
    ...
    features: ["Everything in Professional", "Unlimited Bids", "Featured Homepage Placement", "Dedicated Account Manager", "Custom Profile Banner", "Lead Generation Campaigns", "Accreditation Fast-Track"],
  },
];

const HISTORY = [
  { date: "Mar 1, 2026", plan: "Professional", amount: "$99", status: "Paid", method: "Visa •••• 4242" },
  { date: "Feb 1, 2026", plan: "Professional", amount: "$99", status: "Paid", method: "Visa •••• 4242" },
  { date: "Jan 1, 2026", plan: "Starter", amount: "$49", status: "Paid", method: "Visa •••• 4242" },
  { date: "Dec 1, 2025", plan: "Starter", amount: "$49", status: "Paid", method: "Visa •••• 4242" },
];
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <div className="text-right">
            <p className="text-3xl font-black text-teal-600">$99<span className="text-base font-semibold text-gray-500">/mo</span></p>
        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-2">
            {PLANS[1].features.map(f => (
              <span key={f} className="flex items-center gap-1 text-xs bg-teal-50 text-teal-700 px-2.5 py-1 rounded-full font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {PLANS.map(plan => (
            <div key={plan.name} className={`relative rounded-xl border-2 p-5 space-y-4 ${plan.color}`}>
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-teal-500 text-white text-xs font-black px-4 py-1 rounded-full flex items-center gap-1">
