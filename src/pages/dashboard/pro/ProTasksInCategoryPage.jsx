...
export default function ProTasksInCategoryPage() {
        ...
        {sorted.map(task => (
          <div key={task.id} onClick={() => setSelectedTask(task)}
            ...
            <div className="flex items-start justify-between">
              ...
              <button className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-bold text-sm transition-colors flex-shrink-0">
                View Details
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-black text-amber-600 text-lg">{selectedTask.bids}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button className="flex-1 px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-bold text-sm transition-colors">
                Submit Bid
              </button>
            </div>
          </div>
