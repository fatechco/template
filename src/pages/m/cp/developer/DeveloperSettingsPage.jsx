    ...
    <div className="min-h-screen bg-[#F3F4F6]">
      <div className="px-4 py-5 space-y-5 pb-32">
        ...
        <SettingsSection label="ACCOUNT">
          <SettingsNavItem emoji="👤" label="Edit Profile" onPress={() => navigate("/m/cp/developer/profile")} />
          <div className="h-px bg-[#F3F4F6] mx-4" />
        ...
        <SettingsSection label="LEGAL">
          ...
          <div className="h-px bg-[#F3F4F6] mx-4" />
          <SettingsNavItem emoji="📞" label="Contact Support" onPress={() => navigate("/m/cp/developer/contact-kemedar")} />
        </SettingsSection>
