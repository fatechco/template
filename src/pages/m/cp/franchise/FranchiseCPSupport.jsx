...
export default function FranchiseCPSupport() {
    ...
    <div className="min-h-full bg-gray-50 pb-24 max-w-[480px] mx-auto">
      ...
      <div className="p-4">
        <div className="bg-white rounded-2xl p-6 border border-gray-100 text-center">
          ...
          <p className="font-black text-gray-900 mb-2">Support Tickets</p>
          <p className="text-sm text-gray-500">Manage your support requests here</p>
        </div>
      </div>
    </div>
  );
