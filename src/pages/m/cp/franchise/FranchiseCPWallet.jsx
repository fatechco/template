...
import { ChevronLeft, Menu, DollarSign } from "lucide-react";
import FranchiseOwnerDrawer from "@/components/dashboard/FranchiseOwnerDrawer";

export default function FranchiseCPWallet() {
  ...
  return (
    <div className="min-h-full bg-gray-50 pb-24 max-w-[480px] mx-auto">
      <div className="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        ...
        <h1 className="text-base font-black text-gray-900">Wallet</h1>
        <button className="p-1.5 hover:bg-gray-100 rounded-lg">
          <DollarSign size={22} className="text-gray-900" />
        </button>
      </div>
      ...
      <div className="p-4">
        <div className="bg-white rounded-2xl p-6 border border-gray-100 text-center">
          ...
          <p className="font-black text-gray-900 mb-2">Wallet</p>
