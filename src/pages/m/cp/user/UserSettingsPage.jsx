  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6]">
      ...
      <div className="sticky top-0 z-40 bg-white border-b border-[#E5E7EB] px-5 flex items-center justify-between" style={{ minHeight: 56 }}>
        ...
        <button onClick={() => navigate(-1)} className="p-1.5 rounded-full hover:bg-gray-100 active:bg-gray-200 transition-colors">
      ...
      <div className="px-4 py-5 space-y-5 pb-32">
        ...
        <SettingsSection label="ACCOUNT">
          <SettingsNavItem emoji="👤" label="Edit Profile" onPress={() => navigate("/m/cp/user/profile")} />
          <div className="h-px bg-[#F3F4F6] mx-4" />
        ...
        <SettingsSection label="LEGAL">
          ...
          <div className="h-px bg-[#F3F4F6] mx-4" />
          <SettingsNavItem emoji="📞" label="Contact Support" onPress={() => navigate("/m/cp/user/contact-kemedar")} />
        </SettingsSection>
