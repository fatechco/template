...
export default function MobileSettings() {
  ...
  // Sheets
  const [sheet, setSheet] = useState(null); // "language" | "currency" | "country"
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6]">
      {/* Top App Bar */}
      <div className="sticky top-0 z-40 bg-white border-b border-[#E5E7EB] px-5 flex items-center" style={{ minHeight: 56 }}>
      ...
      <div className="px-4 py-5 space-y-5 pb-32">
        ...
        <SettingsSection label="ABOUT">
          <SettingsNavItem emoji="ℹ️" label="About Kemedar" onPress={() => {}} />
          <div className="h-px bg-[#F3F4F6] mx-4" />
